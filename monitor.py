...
URL_A_MONITOREAR = os.environ.get("URL_A_MONITOREAR")   # URL que quieres vigilar
...
EMAIL_PASSWORD    = os.environ.get("EMAIL_PASSWORD")  # Contraseña de App de Google (ver README)
